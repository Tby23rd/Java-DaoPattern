...
public class DaoImplementation implements DaoInterface {
    ...
    public DaoImplementation(Connection con3) {
        this.con3 = con3;
    }
    ...
    public void add(Category cat) throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement obj1 = con3.Connection().prepareStatement(qre1);
    ...
    public Category search(String catCode) throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement obj1 = con3.Connection().prepareStatement(qre1, ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
        obj1.setString(1,catCode);
        ResultSet rs = obj1.executeQuery();
